package com.hzy.interfaceService;
...
public interface OrderService {
    ...
    @POST("getOrderdaiqiang")
    Call<ResponseBody> getOrderdaiqiang(@Body RequestBody route);

    @POST("handleTest")
    Call<ResponseBody> login(@Body RequestBody route);
